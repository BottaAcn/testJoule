#!/usr/bin/env python3
"""
Test Sequence: READ -> ANDATA -> READ -> RITORNO -> READ
Verifica il ciclo completo partendo da ANDATA
"""
...
def main():
    print(f"\n{'#'*60}")
    print(f"# TEST SEQUENCE: READ -> ANDATA -> READ -> RITORNO -> READ")
    ...
    # 1. READ iniziale (dovrebbe trovare ordine in 142A dopo precedente RITORNO)
    ...
    # 3. READ dopo ANDATA (dovrebbe trovare ordine in 140A)
    ...
    # 5. READ finale (dovrebbe trovare ordine in 142A)
    read_orders(token, "142A")
