# Test ANDATA - Cambio Plant 142A -> 140A
...
# Chiama ANDATA
Write-Host "Eseguo ANDATA (Plant 142A -> 140A)...`n" -ForegroundColor Yellow
...
$result = Invoke-RestMethod -Uri "$serviceUrl/scheduleMassChange" -Method POST -Headers @{
